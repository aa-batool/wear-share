...
const ADMIN_ITEMS = [
  { id: "gown-01", name: "Deep Plum Velvet Gown", category: "Dresses", size: "M", condition: "Excellent", status: "rented", rentPerDay: 13, buyPrice: 150, rentOnly: false, buyOnly: false, provider: "Provider #A12", description: "Floor-length velvet gown with a fitted waist.", photos: [] },
  { id: "wrap-01", name: "Terracotta Wrap Dress", category: "Dresses", size: "S", condition: "Like new", status: "sold", rentPerDay: 8, buyPrice: 58, rentOnly: false, buyOnly: false, provider: "Provider #B04", description: "A-line wrap in a warm terracotta.", photos: [] },
  { id: "coat-01", name: "Fawn Wool Overcoat", category: "Outerwear", size: "M", condition: "Very good", status: "listed", rentPerDay: 10, buyPrice: 92, rentOnly: false, buyOnly: false, provider: "Provider #A12", description: "Double-breasted wool coat, a couple of winters in.", photos: [] },
  { id: "blazer-01", name: "Bottle Green Velvet Blazer", category: "Outerwear", size: "L", condition: "Excellent", status: "in_transit", rentPerDay: 9, buyPrice: 78, rentOnly: false, buyOnly: false, provider: "Provider #C09", description: "Covered-button velvet blazer with a bit of drama.", photos: [] },
  { id: "gown-02", name: "Blush Tulle Gown", category: "Dresses", size: "S", condition: "Excellent", status: "returned", rentPerDay: 14, buyPrice: 158, rentOnly: false, buyOnly: false, provider: "Provider #B04", description: "Layered tulle skirt, sweetheart bodice.", photos: [] },
  { id: "blouse-01", name: "Ivory Silk Blouse", category: "Tops", size: "M", condition: "Good", status: "listed", rentPerDay: 5, buyPrice: 26, rentOnly: true, buyOnly: false, provider: "Provider #C09", description: "Simple, well-cut silk blouse.", photos: [] },
  { id: "skirt-01", name: "Charcoal Pleated Midi", category: "Skirts", size: "S", condition: "Very good", status: "intake", rentPerDay: 6, buyPrice: 33, rentOnly: false, buyOnly: false, provider: "Provider #A12", description: "Knife-pleated midi skirt. Not yet photographed.", photos: [] },
  { id: "gown-03", name: "Ink Blue Satin Gown", category: "Dresses", size: "L", condition: "Excellent", status: "retired", rentPerDay: 13, buyPrice: 149, rentOnly: false, buyOnly: true, provider: "Provider #B04", description: "Deep satin gown with a slit and open back. Worn through, retired from rotation.", photos: [] },
  { id: "top-02", name: "Sage Linen Shirt", category: "Tops", size: "L", condition: "Good", status: "intake", rentPerDay: 4, buyPrice: 20, rentOnly: false, buyOnly: false, provider: "Provider #D21", description: "Just arrived, awaiting photography.", photos: [] },
];
